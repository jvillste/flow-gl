...
(defn barless-root [view-context]
  {:local-state {:sentences {0 "The market economy does not solve the economic calculation problem"
                             1 "The parties involved in trade do not have all of the necessary information available to make rational decisions."
                             2 ""}}
